...
class AsymmetricTrapezoidProfile {
  public:
     ...
     */
    AsymmetricTrapezoidProfile(double max_v, double accel, double decel);
     ...
     */
    a_motion_t calculate(double time_s);
  ...
  private:
    ...
    double decel;      ///< the rate of deceleration to use for this profile.
