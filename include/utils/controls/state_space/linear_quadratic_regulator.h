...
class LinearQuadraticRegulator {
    ...
    LinearQuadraticRegulator(LinearSystem<STATES, INPUTS, OUTPUTS> &plant, const VectorX &Qtolerances, const VectorU &Rtolerances, const double &dt) : LinearQuadraticRegulator(plant.A(), plant.B(), Qtolerances, Rtolerances, dt) {}
     ...
     * @param Rtolerances A vector of tolerances for each input.
     */
    LinearQuadraticRegulator(const MatrixA &A, const MatrixB &B, const VectorX &Qtolerances, const VectorU &Rtolerances, const double &dt) : LinearQuadraticRegulator(A, B, cost_matrix(Qtolerances), cost_matrix(Rtolerances), dt) {}
