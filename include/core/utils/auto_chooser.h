 ...
 * This class was built as a way of using the robot screen to list autonomous programs, and the
 * touchscreen to select them.
 */
class AutoChooser : public screen::Page {
   ...
   protected:
    /**
     *  entry_t is a datatype used to store information that the chooser knows about an auto
     * selection button
     */
    struct entry_t {
        Rect rect;
