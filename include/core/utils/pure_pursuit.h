 ...
 */
extern std::vector<Translation2d> line_circle_intersections(Translation2d center, double r, Translation2d point1,
...
extern std::vector<Translation2d> smooth_path(const std::vector<Translation2d>& path, double weight_data,
