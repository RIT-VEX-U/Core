 ...
 */
extern std::vector<Translation2d> line_circle_intersections(
 ...
 */
extern Translation2d get_lookahead(
 ...
 */
extern std::vector<Translation2d> inject_path(
...
extern std::vector<Translation2d> smooth_path(
...
extern std::vector<Translation2d> smooth_path_cubic(
        const std::vector<Translation2d>& path, double res
);
 ...
 */
extern std::vector<Translation2d> smooth_path_hermite(
        const std::vector<hermite_point>& path, double step
);
 ...
 */
extern double estimate_remaining_dist(
