...
class UnscentedKalmanFilter {
 public:
   ...
   */
  UnscentedKalmanFilter(const std::function<StateVector(const StateVector&, const InputVector&)>& f,
                        const std::function<OutputVector(const StateVector&, const InputVector&)>& h,
                        const WithInputIntegrator& integrator, const StateVector& state_stddevs,
  ...
  void predict(const InputVector& u, double dt) {
    ...
    auto [xhat, S] = square_root_ut<STATES, STATES>(sigmas_F_, pts_.Wm(), pts_.Wc(), mean_func_X_, residual_func_X_,
  ...
  void correct(const InputVector& u, const OutputVector& y) {
    correct<OUTPUTS>(u, y, h_, measurement_stddevs_, mean_func_Y_, residual_func_Y_, residual_func_X_, add_func_X_);
  }
  ...
  void correct(const InputVector& u, const OutputVector& y, const EVec<OUTPUTS>& measurement_stddevs) {
    correct<OUTPUTS>(u, y, h_, measurement_stddevs, mean_func_Y_, residual_func_Y_, residual_func_X_, add_func_X_);
  }
