 ...
 * steps of the path can be added with add() and when ready, calling run() will begin executing the
 * path
 */
class GenericAuto {
   public:
     ...
     */
    [[deprecated("Use CommandController instead.")]] bool run(bool blocking);

    /**
     * Add a new state to the autonomous via function point of type "bool (ptr*)()"
     * @param new_state the function to run
     */
    [[deprecated("Use CommandController instead.")]] void add(state_ptr new_state);

    /**
     * Add a new state to the autonomous via function point of type "bool (ptr*)()" that will run
     * asynchronously
     * @param async_state the function to run
     */
    [[deprecated("Use CommandController instead.")]] void add_async(state_ptr async_state);
