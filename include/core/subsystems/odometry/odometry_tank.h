...
class OdometryTank : public OdometryBase {
 public:
   ...
   */
  OdometryTank(vex::motor_group& left_side, vex::motor_group& right_side, robot_specs_t& config,
  ...
  OdometryTank(CustomEncoder& left_custom_enc, CustomEncoder& right_custom_enc, robot_specs_t& config,
               vex::inertial* imu = NULL, bool is_async = true);
  ...
  OdometryTank(vex::encoder& left_vex_enc, vex::encoder& right_vex_enc, robot_specs_t& config,
               vex::inertial* imu = NULL, bool is_async = true);
