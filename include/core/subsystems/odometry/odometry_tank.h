...
class OdometryTank : public OdometryBase {
   public:
     ...
     * encoders.
     * @param is_async If true, position will be updated in the background continuously. If false,
     * the programmer will have to manually call update().
     */
    OdometryTank(
   ...
   private:
    /**
     * Get information from the input hardware and an existing position, and calculate a new current
     * position
     */
