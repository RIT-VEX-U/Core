...
// class OdometryTankLidar : public OdometryBase {
//   public:
//     OdometryTankLidar(
...
//       vex::motor_group &right_side, const uint32_t &port, const uint32_t &baudrate, const Transform2d &lidar_offset,
//       const double &Kvl, const double &Kal, const double &Kva, const double &Kaa
//     );
