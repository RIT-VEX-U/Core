 ...
 * @returns An optional that, when the screen is running and being touched, stores a Point2d object representing
 ...
 * @returns An optional that, when the screen is running and being held, stores a Point2d object representing
