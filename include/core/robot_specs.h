...
typedef struct {
  ...
  double drive_correction_cutoff;  ///< the distance at which to stop trying to turn towards the
                                   ...
                                   ///< driving forward to minimize our distance but will not try to
  ...
  Feedback* correction_pid;  ///< the pid controller to keep the robot driving in as straight a line
                             ///< as possible
