...
/**
 * Class for visiting parts from a response packet and modifying the parts we have in response to
 * the packet essentially takes the response data and moves it into our data
 */
class ResponsePacketVisitor : public VDP::Visitor {
   public:
    /**
     * Class for visiting parts from a response packet and modifying the parts we have in response
     * to the packet essentially takes the response data and moves it into our data
