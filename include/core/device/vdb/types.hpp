...
class Record : public Part {
   ...
   public:
     ...
     * a Record is essentially an array of parts that is formatted so that it can be sent to the
     * debug board
...
class Number : public Part {
   ...
   public:
    ...
    using FetchFunc = std::function<NumberType()>; /**
                                                    ...
                                                    * @param fetcher the function to run when
                                                    * fetching this number
                                                    */
    explicit Number(
...
class Float : public Number<float, Type::Float> {
   public:
    ...
    Float(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Double : public Number<double, Type::Double> {
   public:
    ...
    Double(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
...
class Uint8 : public Number<uint8_t, Type::Uint8> {
   public:
    ...
    Uint8(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Uint16 : public Number<uint16_t, Type::Uint16> {
   public:
    ...
    Uint16(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Uint32 : public Number<uint32_t, Type::Uint32> {
   public:
    ...
    Uint32(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Uint64 : public Number<uint64_t, Type::Uint64> {
   public:
    ...
    Uint64(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
...
class Int8 : public Number<int8_t, Type::Int8> {
   public:
    ...
    Int8(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Int16 : public Number<int16_t, Type::Int16> {
   public:
    ...
    Int16(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
class Int32 : public Number<int32_t, Type::Int32> {
   public:
    ...
    Int32(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
...
class Int64 : public Number<int64_t, Type::Int64> {
   public:
    ...
    Int64(std::string name, NumT::FetchFunc func = []() { return (NumT::NumberType)0; });
    void Visit(Visitor*);
    PartPtr clone() override;
};
/**
...
class UpcastNumbersVisitor : public Visitor {
   public:
    virtual void VisitAnyFloat(const std::string& name, double value, const Part*) = 0;
    virtual void VisitAnyInt(const std::string& name, int64_t value, const Part*) = 0;
    virtual void VisitAnyUint(const std::string& name, uint64_t value, const Part*) = 0;
