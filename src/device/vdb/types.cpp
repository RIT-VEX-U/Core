 ...
 * a Record is essentially an array of parts that is formatted so that it can be sent to the debug
 * board
...
void UpcastNumbersVisitor::VisitFloat(Float* f) { VisitAnyFloat(f->get_name(), f->get_value(), f); }
