...
void auto_blue_safe() {
	...
	CommandController cc {
		...
		drive_sys.DriveToPointCmd({120, 89.25}, vex::reverse, 1)->withTimeout(1),
		...
		intake_sys.IntakeCmd(10),
		drive_sys.DriveToPointCmd({96, 120}, vex::forward, 0.5)->withTimeout(1),
		// drive_sys.DriveForwardCmd(12, vex::reverse, 0.2)->withTimeout(1),
		drive_sys.TurnToHeadingCmd(225, 1)->withTimeout(0.5),
		intake_sys.OuttakeCmd(10),
		...
		drive_sys.TurnToPointCmd(108,36, vex::forward, 1)->withTimeout(0.5),
		drive_sys.DriveToPointCmd({108,42}, vex::forward, 1)->withTimeout(2),
		drive_sys.TurnDegreesCmd(180, 1)->withTimeout(1),
		clamper_sys.ClampCmd(ClamperSys::ClamperState::UNCLAMPED),
		//get to last position
		drive_sys.TurnToPointCmd(120, 96, vex::forward, 1)->withTimeout(0.5),
		drive_sys.DriveToPointCmd({120, 96}, vex::forward, 1)->withTimeout(2),
		drive_sys.TurnToPointCmd(90, 100, vex::forward, 1)->withTimeout(0.5),
		drive_sys.DriveToPointCmd({90, 100}, vex::forward, 1)->withTimeout(1),
		drive_sys.TurnToHeadingCmd(260, 1)->withTimeout(0.5),
