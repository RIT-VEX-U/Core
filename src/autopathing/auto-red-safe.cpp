...
void auto_red_safe() {
	...
	CommandController cc {
		...
		new DelayCommand(50),
		drive_sys.TurnToHeadingCmd(180, 1)->withTimeout(0.4),
		...
		drive_sys.DriveForwardCmd(24, vex::reverse, 0.4)->withTimeout(1),
		...
		drive_sys.TurnToHeadingCmd(135, 1)->withTimeout(2),
		drive_sys.DriveForwardCmd(34, vex::forward, 1)->withTimeout(1),
		drive_sys.DriveForwardCmd(2.5, vex::reverse, 1)->withTimeout(0.8),
		drive_sys.DriveForwardCmd(4, vex::forward, 1)->withTimeout(1),
		drive_sys.DriveForwardCmd(2.5, vex::reverse, 1)->withTimeout(0.8),
		drive_sys.DriveForwardCmd(4, vex::forward, 1)->withTimeout(1),
		drive_sys.DriveForwardCmd(2.5, vex::reverse, 1)->withTimeout(0.8),
		drive_sys.DriveForwardCmd(4, vex::forward, 1)->withTimeout(1),
		...
		drive_sys.DriveToPointCmd({36,36}, vex::forward, 1)->withTimeout(2),
