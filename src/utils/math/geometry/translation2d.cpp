 ...
 */
Rotation2d Translation2d::theta() { return Rotation2d(m_x, m_y); }
 ...
 */
Eigen::Vector2d Translation2d::as_vector() { return Eigen::Vector2d(m_x, m_y); }
 ...
 */
double Translation2d::distance(const Translation2d &other) { return std::hypot(m_x - other.x(), m_y - other.y()); }
 ...
 */
Translation2d Translation2d::rotate_around(const Translation2d &other, const Rotation2d &rotation) {
 ...
 */
Translation2d Translation2d::operator+(const Translation2d &other) { return {m_x + other.x(), m_y + other.y()}; }
 ...
 */
Translation2d Translation2d::operator-() { return {-m_x, -m_y}; }
 ...
 */
Translation2d Translation2d::operator*(const double &scalar) { return {m_x * scalar, m_y * scalar}; }
 ...
 */
double Translation2d::operator*(const Translation2d &other) { return (m_x * other.m_x) + (m_y * other.m_y); }
 ...
 */
bool Translation2d::operator==(const Translation2d &other) { return std::abs(m_x - other.m_x) < 1e-9 && std::abs(m_y - other.m_y) < 1e-9; }
