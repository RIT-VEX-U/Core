 ...
 */
double MovingAverage::get_value() const { return current_avg; }

// How many samples the average is made from
int MovingAverage::get_size() const { return buffer.size(); }
 ...
 * @return the number of samples used to calculate this average
 */
double ExponentialMovingAverage::get_value() const { return current_avg; }

// How many samples the average is made from
int ExponentialMovingAverage::get_size() { return buffer.size(); }
