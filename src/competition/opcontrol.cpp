...
void skills() {
    ...
    con.ButtonA.pressed([]() {
        ...
        // drop the intake
          drive_sys.DriveForwardCmd(5, vex::reverse, 1, 0)->withTimeout(0.3),
          intake_command(),
          ...
          drive_sys.DriveToPointCmd({72, 120}, vex::forward, 0.5, 0)->withTimeout(1),
...
void testing() {
    ...
    con.ButtonA.pressed([]() {
        ...
        CommandController cc{
          ...
          // UNTESTED
          // Final rings
          drive_sys.TurnToHeadingCmd(135, 1, 0)->withTimeout(0.5), goal_grabber_command(false),
          drive_sys.DriveForwardCmd(14, vex::reverse, 0.6, 0)->withTimeout(1),
          drive_sys.DriveForwardCmd(8, vex::fwd, 1, 0)->withTimeout(1),
